 ...
 *
 * A high-fidelity industrial toggle switch with glass tube aesthetics,
 * animated filaments, and complex layered visual effects.
 *
 * Design Inspiration:
 * - Industrial power switches and vintage electrical equipment
 * - Glass vacuum tubes with visible filaments
 * - Brushed steel mechanisms with screw details
 *
 * Visual Features:
 * - Steel mechanism with 5-part screw SVG (animated on state change)
 * - Glass tube section with noise texture overlay
 * - Animated filament paths (on/off states)
 * - Linear gradient steel fills with realistic metallic appearance
 * - Orange (#ff8800) primary accent color
 * - Background grid pattern with ambient glow effects
 *
 * Animations:
 * - Case slides left (-40px) when unchecked
 * - Screw elements pulse with staggered timing
 * - Filament SVG paths animate strokeDashoffset
 * - Glass section shows border trace animation on hover
 * - Shimmer reflex sweep on hover
 *
 * States:
 * - isChecked: Toggle on/off state (controls case position, filament glow)
 * - isHovered: Hover state (controls glow effects, animations)
 *
 * @example
 * <AnimatedButton />
 */
                  ...
                  <div className="absolute top-0 bottom-0 -right-px">
                    <motion.div
                      ...
                      style={{
                        ...
                        boxShadow: !isChecked ? "1px 0 10px 3px rgba(255, 220, 145, 0.4)" : "1px 0 10px 3px #ffa600",
                      }}
                      animate={{
                        height: ["0%", "100%", "140%"],
                ...
                <div className="relative h-[78px] w-[190px] rounded-l-[10px] rounded-r-[100px] flex items-center justify-center">
                  ...
                  >
                    <motion.path
                      ...
                      animate={{
                        strokeDashoffset: isHovered && isChecked ? [430, 0] : 430,
                        filter: isHovered && isChecked ? ["blur(2px)", "blur(4px)", "blur(2px)"] : "blur(0px)",
                      }}
                      transition={{
                        duration: 1.4,
                        repeat: isHovered && isChecked ? Number.POSITIVE_INFINITY : 0,
                      }}
                      style={{ color: "#ff8800" }}
                    />
                  </motion.svg>
                  ...
                  >
                    ...
                    >
                      ...
                      <rect filter="url(#noise-filter-glass)" fill="#ffffff" height={700} width={700} />
                    </svg>
                    ...
                    <svg
                      ...
                      viewBox="0 0 49 52"
                      height={26}
                      className="absolute left-0 top-0 bottom-0 my-auto w-auto opacity-30"
                    ...
                    <motion.svg
                      ...
                      viewBox="0 0 49 52"
                      height={26}
                      className="absolute left-0 top-0 bottom-0 my-auto w-auto"
                      style={{ strokeWidth: "2px" }}
                      initial={{ opacity: 1 }}
                    >
                      <motion.path
