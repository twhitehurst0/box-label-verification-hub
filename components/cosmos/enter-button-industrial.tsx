...
/**
 * EnterButtonIndustrial Component
 *
 * A high-fidelity industrial-style Enter button with glass tube aesthetics,
 * floating animation, and ambient glow effects. Designed to complement
 * the Cosmos 3D gallery visual theme.
 *
 * Visual Features:
 * - Steel mechanism with screw-like SVG elements
 * - Glass tube section with noise texture and reflections
 * - Pulsing orange (#ff8800) ambient glow
 * - Floating idle animation (vertical bob)
 * - Glowing "ENTER" text on hover/press
 * - SVG path animation around the glass border
 *
 * Animations:
 * - Idle: Gentle 3-second floating loop (y: 0 -> -8 -> 0)
 * - Hover: Stops floating, scales to 1.05x
 * - Press: Scales to 0.96x, flashes internal glow
 *
 * @example
        ...
        >
          <div className="flex flex-col items-center gap-4">
            <motion.div
              ...
              animate={{
                y: isHovered ? 0 : [0, -8, 0],
                scale: isPressed ? 0.96 : isHovered ? 1.05 : 1,
              }}
              transition={{
                y: {
                  duration: 3,
            ...
            >
              {/* Subtle ambient background glow - orange #ff8800 */}
              <motion.div
                className="absolute inset-0 rounded-[100px] pointer-events-none"
                style={{
                  background: "radial-gradient(ellipse 120% 150% at 50% 50%, rgba(255, 136, 0, 0.15) 0%, rgba(255, 136, 0, 0.08) 30%, transparent 70%)",
                  filter: "blur(20px)",
                  transform: "scale(1.8)",
                }}
                animate={{
              ...
              <motion.div
                className="absolute inset-0 rounded-[100px] pointer-events-none"
                style={{
                  background: "radial-gradient(ellipse 100% 100% at 50% 50%, rgba(255, 136, 0, 0.1) 0%, transparent 60%)",
                  filter: "blur(40px)",
                  transform: "scale(2.5)",
                }}
                animate={{
                          ...
                          {i === 1 && (
                            <>
                              <path
                                ...
                                strokeWidth={2}
                                stroke="#262626"
                                fill="url(#paint_linear_steel_cosmos)"
                ...
                <div className="relative h-[78px] w-[190px] rounded-l-[10px] rounded-r-[100px] flex items-center justify-center">
                  ...
                  >
                    ...
                    >
                      ...
                      <rect filter="url(#noise-filter-glass-cosmos)" fill="#ffffff" height={700} width={700} />
                    </svg>
