...
const INFERENCE_ACCENT = "#a855f7" // Purple accent for inference
...
function LiquidGlassNavbar({ scrolled, accentColor }: { scrolled: boolean; accentColor: string }) {
            ...
            >
              ...
              <Link href="/ocr">
                <motion.span
                  ...
                  style={{
                    fontFamily: "'SF Pro Display', -apple-system, BlinkMacSystemFont, sans-serif",
                    backgroundImage: `linear-gradient(135deg, rgba(255,255,255,0.95) 0%, ${accentColor} 50%, rgba(255,255,255,0.9) 100%)`,
